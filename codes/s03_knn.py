...
class RegressionAnalysis:
    ...
    def train_knn(self, X_train, y_train):
        param_grid = {
            'reg__n_neighbors': [3, 5, 7, 9, 11, 13],
            'reg__weights': ['uniform', 'distance'],
            'reg__p': [1, 2],  # 曼哈顿/欧氏
        }
        return self._fit_grid("KNN", KNeighborsRegressor(), param_grid, X_train, y_train, scale=True)
    ...
    def save_results_to_excel(self):
        ...
        filename = self.output_dir / f'KNN_Model_Results_{timestamp}.xlsx'
