...
class RegressionAnalysis:
    ...
    def train_mlp(self, X_train, y_train):
        ...
        param_grid = {
            ...
            'reg__learning_rate_init': [1e-3, 3e-3, 1e-2],
        }
        return self._fit_grid("MLP", mlp, param_grid, X_train, y_train, scale=True)
    ...
    def save_results_to_excel(self):
        ...
        filename = self.output_dir / f'MLP_Model_Results_{timestamp}.xlsx'
